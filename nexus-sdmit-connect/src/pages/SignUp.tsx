...
export default function SignUp() {
  ...
  const validateEmail = () => {
    if (!formData.email.endsWith('@sdmit.in') && !formData.email.endsWith('@admin.sdmit.in')) {
      toast({
        title: "Invalid Email",
        description: "Please use your SDMIT email (@sdmit.in) or admin email (@admin.sdmit.in)",
        variant: "destructive"
      })
      return false
    }
